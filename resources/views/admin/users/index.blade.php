                        ...
                        @if (Auth::user()->id !== $user->id)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    @if ($user->trashed())
                                        <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#activate-user-{{$user->id}}">
                                            <i class="fa-solid fa-user-checked"></i> Activate {{$user->name}}
                                        </button>
                                    @else
